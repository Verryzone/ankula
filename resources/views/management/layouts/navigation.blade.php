...
<nav class="bg-white border-gray-200 dark:bg-gray-900 z-20 fixed w-full top-0 right-0 h-16 shadow">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto h-16 px-4">
        <div class="flex items-center h-16">
            <a href="" class="flex items-center space-x-3 rtl:space-x-reverse">
                <svg id="logo-86" width="30" height="30" viewBox="0 0 40 40" fill="none"
                ...
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Ankula</span>
            </a>
            <div class="relative hidden md:block ml-10">
        ...
        <div class="flex items-center h-16">
            ...
            <div id="dropdown"
                ...
                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                    <li>
                        <a href="{{ route('management.profile.edit') }}"
...
{{-- <div class="pt-16">
  <div class="flex">
    <aside class="fixed top-16 left-0 w-64 h-[calc(100vh-4rem)] ..."> ... </aside>
    <main class="flex-1 ml-64 p-4"> ... </main>
  </div>
</div> --}}