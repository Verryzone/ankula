<div id="drawer-update-category-default"
      ...
      <h5 id="drawer-label"
            ...
            Update category</h5>
      <button type="button" id="update-drawer-cancel" data-drawer-dismiss="drawer-update-category-default"
      ...
      <form action="#" onsubmit="update_category(event)">
            @csrf
            @method('patch')
            <div class="space-y-4">
                  <div>
                        ...
                        <input type="text" name="name" id="name"
                              ...
                              value="" placeholder="Type category name" required="">
                  </div>
            ...
            <div>
                  <input type="hidden" name="id" id="id-update" value="0">
            </div>
            <div class="bottom-0 left-0 flex justify-center w-full pb-4 mt-4 space-x-4 sm:absolute sm:px-4 sm:mt-0">
                  ...
                  {{-- <button type="button"
                        class="w-full justify-center text-red-600 inline-flex items-center hover:text-white border border-red-600 hover:bg-red-600 focus:ring-4 focus:outline-hidden focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900">
