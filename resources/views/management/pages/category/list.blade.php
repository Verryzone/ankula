<x-management-app-layout>
    <div class="py-12 lg:px-3">
        <div class="p-4 bg-white block sm:flex items-center justify-between border-b rounded-top-lg border-gray-200 lg:mt-1.5 dark:bg-gray-800 dark:border-gray-700 rounded-lg">
                                    ...
                                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                        ...
                                        <td class="p-4 space-x-2 whitespace-nowrap">
                                            <button type="button" id="updatecategoryButton"
                                                ...
                                                data-drawer-placement="right"
                                                class="updatecategoryButton inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-blue-700 dark:focus:ring-primary-800">
                                                <img id="loading-{{ $category->id }}"
                                                    src="{{ asset('src/images/loading.gif') }}" width="12px"
                                                    height="12px" alt="" class="mr-1 hidden">
                                                <svg id="editlogo-{{ $category->id }}" class="w-4 h-4 mr-2"
                                            ...
                                            <button onclick="push_state('{{ $category->id }}')" type="button"
                                                ...
                                                data-drawer-placement="right"
                                                class="deletecategoryButton inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-red-700 rounded-lg hover:bg-red-800 focus:ring-4 focus:ring-red-300 dark:focus:ring-red-900">
        ...
        @include('management.pages.category.edit')

        <!-- Delete category Drawer -->
        @include('management.pages.category.delete')
