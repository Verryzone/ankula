      ...
      <form action="#" onsubmit="update_product(event)">
            ...
            <div class="space-y-4">
                  <div class="flex justify-center mb-4">
                        <div class="w-32 h-32 flex items-center justify-center bg-gray-100 rounded-lg border border-gray-300 dark:border-gray-600">
                            <img id="preview-image" src="" alt="Preview" class="object-cover w-full h-full rounded-lg hidden">
                        </div>
                  </div>
                  <div>
...
<script>
    // Fungsi untuk set preview dari database (dipanggil dari JS saat edit)
